...
/***/ function(module, exports, __webpack_require__) {
	...
	var PriorityQueue = __webpack_require__(169).PriorityQueue;
	...
	var imageSrcs = [{ src: 'lol.png', begin: {}, current: {} }, { src: 'A.png', begin: {}, current: {} }, { src: 'N.png', begin: {}, current: {} }, { src: 'H.png', begin: {}, current: {} }, { src: 'M.png', begin: {}, current: {} }, { src: 'U.png', begin: {}, current: {} }, { src: 'O.png', begin: {}, current: {} }, { src: 'N.png', begin: {}, current: {} }, { src: 'beauty.png', begin: {}, current: {} }, { src: 'X.png', begin: {}, current: {} }, { src: 'E.png', begin: {}, current: {} }, { src: 'P.png', begin: {}, current: {} }, { src: 'H.png', begin: {}, current: {} }, { src: 'I.png', begin: {}, current: {} }, { src: 'N.png', begin: {}, current: {} }, { src: 'H.png', begin: {}, current: {} }];
	...
	function draw(ctx) {
	    ...
	    loadImages(function (imgObjs) {
	        for (i = 0; i < N; i++) {
	            ctx.drawImage(imgObjs[imageSrcs[i].current.x * squareN + imageSrcs[i].current.y], i % squareN * (IMG_WIDTH + 1) + 1, Math.floor(i / squareN) * (IMG_HEIGHT + 1) + 1);
	        }
	    });
	...
	function AStar(problem) {
	    ...
	    var actions = travel.map(function (item) {
	        return item.action;
	    });
	    console.log(actions);
	...
	function RBFS(problem) {
	    ...
	    var actions = steps.map(function (item) {
	        return item.action;
	    });
	...
	var testMap0 = [[{ "x": 0, "y": 2 }, { "x": 0, "y": 1 }, { "x": 3, "y": 2 }, { "x": 2, "y": 1 }], [{ "x": 0, "y": 3 }, { "x": 3, "y": 0 }, { "x": 1, "y": 0 }, { "x": 3, "y": 3 }], [{ "x": 2, "y": 3 }, { "x": 2, "y": 0 }, { "x": 0, "y": 0 }, { "x": 3, "y": 1 }], [{ "x": 1, "y": 2 }, { "x": 2, "y": 2 }, { "x": 1, "y": 3 }, { "x": 1, "y": 1 }]];

	var testMap1 = [[{ "x": 0, "y": 1 }, { "x": 0, "y": 2 }, { "x": 0, "y": 3 }, { "x": 1, "y": 3 }], [{ "x": 1, "y": 0 }, { "x": 1, "y": 1 }, { "x": 1, "y": 2 }, { "x": 0, "y": 0 }], [{ "x": 2, "y": 0 }, { "x": 2, "y": 1 }, { "x": 2, "y": 2 }, { "x": 2, "y": 3 }], [{ "x": 3, "y": 0 }, { "x": 3, "y": 1 }, { "x": 3, "y": 2 }, { "x": 3, "y": 3 }]];
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                'div',
	                { style: { "height": "100%" } },
	                React.createElement('canvas', { ref: '_canvas' })
	            ),
	            React.createElement(
	                'div',
	                null,
...
/***/ function(module, exports) {
	...
	(function () {
	  ...
	  var exports = typeof module !== 'undefined' && module.exports ? module.exports : window.priority_queue = {};
	  ...
	  exports.PriorityQueue = function PriorityQueue(compare, queue) {
	    ...
	    this.__defineGetter__('length', function length() {
	      return queue.length;
	    });

	    for (var i = parent(queue.length - 1); i >= 0; --i) {
	      heapify(i);
	    }
	  };
	  ...
	  var max_first = exports.max_first = function max_first(a, b) {
	    return b - a;
	  },
	      min_first = exports.min_first = function min_first(a, b) {
	    return a - b;
	  };
	})(); // end of namespace
